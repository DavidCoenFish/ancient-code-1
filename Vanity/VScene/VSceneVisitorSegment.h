//file: Vanity/VScene/VSceneVisitorSegment.h
#ifndef _V_SCENE_VISITOR_SEGMENT_H_
#define _V_SCENE_VISITOR_SEGMENT_H_
...
#endif // _V_SCENE_VISITOR_SEGMENT_H_